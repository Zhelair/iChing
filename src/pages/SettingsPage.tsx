...
const privacyCopy: Partial<Record<Locale, PrivacyCopy>> = {
  en: {
    ...
    local: 'Your readings, questions, notes, and practice history stay on this device. Resend receives only the necessary details you explicitly enter and submit in Feedback.',
  ...
  bg: {
    ...
    local: 'Вашите прочити, въпроси, бележки и история на практиките остават на това устройство. Resend получава само необходимото, което изрично въведете и изпратите във формата за обратна връзка.',
  ...
  ru: {
    ...
    local: 'Ваши чтения, вопросы, заметки и история практик остаются на этом устройстве. Resend получает только необходимые сведения, которые вы явно вводите и отправляете через форму обратной связи.',
