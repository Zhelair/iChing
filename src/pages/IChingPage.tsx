...
export function IChingPage() {
  ...
  return <div className="page-shell py-10 sm:py-16">
    ...
    <div className="iching-hub mt-8 sm:mt-10">
      <Link to="/reading" className="surface iching-hub__card iching-hub__card--accent"><span><Sparkles size={24} /></span><h2>{t('method.title')}</h2><p>{t('method.body')}</p><strong>{t('home.start')} <ArrowRight size={16} /></strong></Link>
