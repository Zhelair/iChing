...
const copy: Record<BuiltInContentLocale, {
  ...
  bg: {
    ...
    intro: 'Yi Path е безплатно приложение, което пази данните локално. Споделете какво ви е било полезно, сигнализирайте за проблем или подкрепете развитието на проекта. Нито една от тези възможности не отключва допълнителни функции.',
    feedbackTitle: 'Споделете обратна връзка',
    feedbackBody: 'Когато натиснете „Изпрати обратна връзка“, съобщението и незадължителните данни за контакт се изпращат сигурно до разработчика на Yi Path чрез услугата Resend.',
    name: 'Име (по желание)',
    ...
    supportBody: 'Ако Yi Path ви е полезно, можете да ме почерпите с кафе и да помогнете за по-нататъшното му развитие. Това е напълно доброволно.',
    bmac: 'Buy Me a Coffee',
