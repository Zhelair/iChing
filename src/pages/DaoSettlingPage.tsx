...
export function DaoSettlingPage() {
  ...
  return <div className="dao-page dao-route-page">
    ...
    <DaoRouteHeading icon={Wind} eyebrow={shell.modernLabel} title={copy.practiceTitle} body={detail.breathCues[1]} shell={shell} />
    ...
    <div className="page-shell dao-sections">
      <BreathPractice copy={copy} detail={detail} locale={preferences.locale} />
    </div>
    <aside className="page-shell dao-practice-why surface"><strong>{detail.whyHere}</strong><p>{detail.breathWhy}</p><small>{detail.conceptualTrail}</small></aside>
  </div>
}
