...
function validBackup(): YiPathExport {
  ...
  return {
    ...
    preferences: { locale: 'en', theme: 'daylight', sound: false, music: false, ambientVolume: 0, reduceMotion: false, aiEnabled: false, companionEnabled: false, companionPet: 'cat', companionSize: 'normal', petSound: true, petMotion: true },
    readings: [{
      id: 'reading-1',
      schemaVersion: 1,
      contentVersion: 'test-content',
